    ...
    const handleGenerateReport = async () => {
        ...
        try {
            ...
            if(filters.class !== 'all'){
                 const classStudents = students.filter((s: { grade: any; classLetter: any; }) => `${s.grade}${s.classLetter}` === filters.class);
                 const classStudentIds = new Set(classStudents.map((s: { id: any; }) => s.id));
